...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_140633872621264_integer_c_int16_t_0
!PyF95.symbol: mexFunction|template_140633872621264_integer_c_int16_t_0
!PyF95.symbol: test_mx_integer_c_int16_t_0|template_140633872621264_integer_c_int16_t_0
!PyF95.symbol: test_explicit_interface|mexFunction|template_140633872621264_integer_c_int16_t_0
!PyF95.symbol: Foo_integer_c_int16_t_0|test_mx_integer_c_int16_t_0|template_140633872621264_integer_c_int16_t_0
!PyF95.symbol: special_140633872350224_integer_c_int16_t_0_140633470780432|mexFunction|template_140633872621264_integer_c_int16_t_0
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_integer_c_int16_t_0
  use iso_c_binding
  type Foo_integer_c_int16_t_0
    integer(kind=c_int16_t) :: REPIDX_0(x,1)
  end type Foo_integer_c_int16_t_0
end module test_mx_integer_c_int16_t_0
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int16_t), pointer :: REPIDX_0(X,:)
    integer(kind=c_int16_t), pointer :: REPIDX_0(Y,:)
    mwSize :: dims(0)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int16_t), pointer, intent(in) :: REPIDX_0(X,:)
