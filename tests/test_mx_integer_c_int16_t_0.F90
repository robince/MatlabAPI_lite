...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4316070544_integer_c_int16_t_0
!PyF95.symbol: mexFunction|template_4316070544_integer_c_int16_t_0
!PyF95.symbol: test_mx_integer_c_int16_t_0|template_4316070544_integer_c_int16_t_0
!PyF95.symbol: test_explicit_interface|mexFunction|template_4316070544_integer_c_int16_t_0
!PyF95.symbol: Foo_integer_c_int16_t_0|test_mx_integer_c_int16_t_0|template_4316070544_integer_c_int16_t_0
!PyF95.symbol: special_4303250512_integer_c_int16_t_0_4316743120|mexFunction|template_4316070544_integer_c_int16_t_0
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
module test_mx_integer_c_int16_t_0
  ...
  type Foo_integer_c_int16_t_0
    integer(kind=c_int16_t) :: REPIDX(x,1,0)
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int16_t), pointer :: REPIDX(X,:,0)
    integer(kind=c_int16_t), pointer :: REPIDX(Y,:,0)
    mwSize :: dims(0)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int16_t), pointer, intent(in) :: REPIDX(X,:,0)
      mwPointer, intent(out) :: subloc

      subloc = loc( REPIDX(X,1,0) )
