...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_140633872621264_real_c_double_2
!PyF95.symbol: mexFunction|template_140633872621264_real_c_double_2
!PyF95.symbol: test_mx_real_c_double_2|template_140633872621264_real_c_double_2
!PyF95.symbol: test_explicit_interface|mexFunction|template_140633872621264_real_c_double_2
!PyF95.symbol: Foo_real_c_double_2|test_mx_real_c_double_2|template_140633872621264_real_c_double_2
!PyF95.symbol: special_140633872350224_real_c_double_2_140633739087120|mexFunction|template_140633872621264_real_c_double_2
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_real_c_double_2
  use iso_c_binding
  type Foo_real_c_double_2
    real(kind=c_double) :: REPIDX_2(x,1)
  end type Foo_real_c_double_2
end module test_mx_real_c_double_2
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    real(kind=c_double), pointer :: REPIDX_2(X,:)
    real(kind=c_double), pointer :: REPIDX_2(Y,:)
    mwSize :: dims(2)
    ...
    subroutine test_explicit_interface(X, subloc)
      real(kind=c_double), pointer, intent(in) :: REPIDX_2(X,:)
