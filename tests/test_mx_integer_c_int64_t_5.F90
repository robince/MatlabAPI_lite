...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_140633872621264_integer_c_int64_t_5
!PyF95.symbol: mexFunction|template_140633872621264_integer_c_int64_t_5
!PyF95.symbol: test_mx_integer_c_int64_t_5|template_140633872621264_integer_c_int64_t_5
!PyF95.symbol: test_explicit_interface|mexFunction|template_140633872621264_integer_c_int64_t_5
!PyF95.symbol: Foo_integer_c_int64_t_5|test_mx_integer_c_int64_t_5|template_140633872621264_integer_c_int64_t_5
!PyF95.symbol: special_140633872350224_integer_c_int64_t_5_140633738667664|mexFunction|template_140633872621264_integer_c_int64_t_5
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_integer_c_int64_t_5
  use iso_c_binding
  type Foo_integer_c_int64_t_5
    integer(kind=c_int64_t) :: REPIDX_5(x,1)
  end type Foo_integer_c_int64_t_5
end module test_mx_integer_c_int64_t_5
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int64_t), pointer :: REPIDX_5(X,:)
    integer(kind=c_int64_t), pointer :: REPIDX_5(Y,:)
    mwSize :: dims(5)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int64_t), pointer, intent(in) :: REPIDX_5(X,:)
