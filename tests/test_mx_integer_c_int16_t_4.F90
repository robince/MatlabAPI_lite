...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4316070544_integer_c_int16_t_4
!PyF95.symbol: mexFunction|template_4316070544_integer_c_int16_t_4
!PyF95.symbol: test_mx_integer_c_int16_t_4|template_4316070544_integer_c_int16_t_4
!PyF95.symbol: test_explicit_interface|mexFunction|template_4316070544_integer_c_int16_t_4
!PyF95.symbol: Foo_integer_c_int16_t_4|test_mx_integer_c_int16_t_4|template_4316070544_integer_c_int16_t_4
!PyF95.symbol: special_4303250512_integer_c_int16_t_4_4322869200|mexFunction|template_4316070544_integer_c_int16_t_4
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_integer_c_int16_t_4
  use iso_c_binding
  type Foo_integer_c_int16_t_4
    integer(kind=c_int16_t) :: REPIDX(x,1,4)
  end type Foo_integer_c_int16_t_4
end module test_mx_integer_c_int16_t_4
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int16_t), pointer :: REPIDX(X,:,4)
    integer(kind=c_int16_t), pointer :: REPIDX(Y,:,4)
    mwSize :: dims(4)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int16_t), pointer, intent(in) :: REPIDX(X,:,4)
      mwPointer, intent(out) :: subloc

      subloc = loc( REPIDX(X,1,4) )
