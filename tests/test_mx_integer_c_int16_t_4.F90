...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_140633872621264_integer_c_int16_t_4
!PyF95.symbol: mexFunction|template_140633872621264_integer_c_int16_t_4
!PyF95.symbol: test_mx_integer_c_int16_t_4|template_140633872621264_integer_c_int16_t_4
!PyF95.symbol: test_explicit_interface|mexFunction|template_140633872621264_integer_c_int16_t_4
!PyF95.symbol: Foo_integer_c_int16_t_4|test_mx_integer_c_int16_t_4|template_140633872621264_integer_c_int16_t_4
!PyF95.symbol: special_140633872350224_integer_c_int16_t_4_140634281433296|mexFunction|template_140633872621264_integer_c_int16_t_4
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
module test_mx_integer_c_int16_t_4
  ...
  type Foo_integer_c_int16_t_4
    integer(kind=c_int16_t) :: REPIDX_4(x,1)
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int16_t), pointer :: REPIDX_4(X,:)
    integer(kind=c_int16_t), pointer :: REPIDX_4(Y,:)
    mwSize :: dims(4)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int16_t), pointer, intent(in) :: REPIDX_4(X,:)
