...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4316070544_integer_c_int16_t_5
!PyF95.symbol: mexFunction|template_4316070544_integer_c_int16_t_5
!PyF95.symbol: test_mx_integer_c_int16_t_5|template_4316070544_integer_c_int16_t_5
!PyF95.symbol: test_explicit_interface|mexFunction|template_4316070544_integer_c_int16_t_5
!PyF95.symbol: Foo_integer_c_int16_t_5|test_mx_integer_c_int16_t_5|template_4316070544_integer_c_int16_t_5
!PyF95.symbol: special_4303250512_integer_c_int16_t_5_4322752848|mexFunction|template_4316070544_integer_c_int16_t_5
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
module test_mx_integer_c_int16_t_5
  ...
  type Foo_integer_c_int16_t_5
    integer(kind=c_int16_t) :: REPIDX(x,1,5)
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int16_t), pointer :: REPIDX(X,:,5)
    integer(kind=c_int16_t), pointer :: REPIDX(Y,:,5)
    mwSize :: dims(5)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int16_t), pointer, intent(in) :: REPIDX(X,:,5)
      mwPointer, intent(out) :: subloc

      subloc = loc( REPIDX(X,1,5) )
