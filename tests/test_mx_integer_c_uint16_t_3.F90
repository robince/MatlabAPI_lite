...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4303319312_integer_c_uint16_t_3
!PyF95.symbol: mexFunction|template_4303319312_integer_c_uint16_t_3
!PyF95.symbol: test_mx_integer_c_uint16_t_3|template_4303319312_integer_c_uint16_t_3
!PyF95.symbol: test_explicit_interface|mexFunction|template_4303319312_integer_c_uint16_t_3
!PyF95.symbol: Foo_integer_c_uint16_t_3|test_mx_integer_c_uint16_t_3|template_4303319312_integer_c_uint16_t_3
!PyF95.symbol: special_4303087760_integer_c_uint16_t_3_4324555408|mexFunction|template_4303319312_integer_c_uint16_t_3
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_integer_c_uint16_t_3
  use iso_c_binding
  integer, parameter :: c_uint8_t = c_int8_t
  integer, parameter :: c_uint16_t = c_int16_t
  type Foo_integer_c_uint16_t_3
    integer(kind=c_uint16_t) :: REPIDX_3(x,1)
  end type Foo_integer_c_uint16_t_3
end module test_mx_integer_c_uint16_t_3
...
! LOC
    integer, parameter :: c_uint8_t = c_int8_t
    integer, parameter :: c_uint16_t = c_int16_t
    integer(kind=c_uint16_t), pointer :: REPIDX_3(X,:)
    integer(kind=c_uint16_t), pointer :: REPIDX_3(Y,:)
    mwSize :: dims(3)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_uint16_t), pointer, intent(in) :: REPIDX_3(X,:)
