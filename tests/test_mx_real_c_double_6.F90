...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4316070544_real_c_double_6
!PyF95.symbol: mexFunction|template_4316070544_real_c_double_6
!PyF95.symbol: test_mx_real_c_double_6|template_4316070544_real_c_double_6
!PyF95.symbol: test_explicit_interface|mexFunction|template_4316070544_real_c_double_6
!PyF95.symbol: Foo_real_c_double_6|test_mx_real_c_double_6|template_4316070544_real_c_double_6
!PyF95.symbol: special_4303250512_real_c_double_6_4316379984|mexFunction|template_4316070544_real_c_double_6
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_real_c_double_6
  use iso_c_binding
  type Foo_real_c_double_6
    real(kind=c_double) :: REPIDX(x,1,6)
  end type Foo_real_c_double_6
end module test_mx_real_c_double_6
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    real(kind=c_double), pointer :: REPIDX(X,:,6)
    real(kind=c_double), pointer :: REPIDX(Y,:,6)
    mwSize :: dims(6)
    ...
    subroutine test_explicit_interface(X, subloc)
      real(kind=c_double), pointer, intent(in) :: REPIDX(X,:,6)
