...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_140633872621264_real_c_float_1
!PyF95.symbol: mexFunction|template_140633872621264_real_c_float_1
!PyF95.symbol: test_mx_real_c_float_1|template_140633872621264_real_c_float_1
!PyF95.symbol: test_explicit_interface|mexFunction|template_140633872621264_real_c_float_1
!PyF95.symbol: Foo_real_c_float_1|test_mx_real_c_float_1|template_140633872621264_real_c_float_1
!PyF95.symbol: special_140633872350224_real_c_float_1_140633201354256|mexFunction|template_140633872621264_real_c_float_1
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_real_c_float_1
  use iso_c_binding
  type Foo_real_c_float_1
    real(kind=c_float) :: REPIDX_1(x,1)
  end type Foo_real_c_float_1
end module test_mx_real_c_float_1
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    real(kind=c_float), pointer :: REPIDX_1(X,:)
    real(kind=c_float), pointer :: REPIDX_1(Y,:)
    mwSize :: dims(1)
    ...
    subroutine test_explicit_interface(X, subloc)
      real(kind=c_float), pointer, intent(in) :: REPIDX_1(X,:)
