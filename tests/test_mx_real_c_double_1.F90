...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4316070544_real_c_double_1
!PyF95.symbol: mexFunction|template_4316070544_real_c_double_1
!PyF95.symbol: test_mx_real_c_double_1|template_4316070544_real_c_double_1
!PyF95.symbol: test_explicit_interface|mexFunction|template_4316070544_real_c_double_1
!PyF95.symbol: Foo_real_c_double_1|test_mx_real_c_double_1|template_4316070544_real_c_double_1
!PyF95.symbol: special_4303250512_real_c_double_1_4316360400|mexFunction|template_4316070544_real_c_double_1
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
module test_mx_real_c_double_1
  ...
  type Foo_real_c_double_1
    real(kind=c_double) :: REPIDX(x,1,1)
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    real(kind=c_double), pointer :: REPIDX(X,:,1)
    real(kind=c_double), pointer :: REPIDX(Y,:,1)
    mwSize :: dims(1)
    ...
    subroutine test_explicit_interface(X, subloc)
      real(kind=c_double), pointer, intent(in) :: REPIDX(X,:,1)
