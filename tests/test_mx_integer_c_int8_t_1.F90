...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4316070544_integer_c_int8_t_1
!PyF95.symbol: mexFunction|template_4316070544_integer_c_int8_t_1
!PyF95.symbol: test_mx_integer_c_int8_t_1|template_4316070544_integer_c_int8_t_1
!PyF95.symbol: test_explicit_interface|mexFunction|template_4316070544_integer_c_int8_t_1
!PyF95.symbol: Foo_integer_c_int8_t_1|test_mx_integer_c_int8_t_1|template_4316070544_integer_c_int8_t_1
!PyF95.symbol: special_4303250512_integer_c_int8_t_1_4316404880|mexFunction|template_4316070544_integer_c_int8_t_1
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
module test_mx_integer_c_int8_t_1
  ...
  type Foo_integer_c_int8_t_1
    integer(kind=c_int8_t) :: REPIDX(x,1,1)
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int8_t), pointer :: REPIDX(X,:,1)
    integer(kind=c_int8_t), pointer :: REPIDX(Y,:,1)
    mwSize :: dims(1)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int8_t), pointer, intent(in) :: REPIDX(X,:,1)
