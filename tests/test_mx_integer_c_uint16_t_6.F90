...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4303319312_integer_c_uint16_t_6
!PyF95.symbol: mexFunction|template_4303319312_integer_c_uint16_t_6
!PyF95.symbol: test_mx_integer_c_uint16_t_6|template_4303319312_integer_c_uint16_t_6
!PyF95.symbol: test_explicit_interface|mexFunction|template_4303319312_integer_c_uint16_t_6
!PyF95.symbol: Foo_integer_c_uint16_t_6|test_mx_integer_c_uint16_t_6|template_4303319312_integer_c_uint16_t_6
!PyF95.symbol: special_4303087760_integer_c_uint16_t_6_4322641744|mexFunction|template_4303319312_integer_c_uint16_t_6
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_integer_c_uint16_t_6
  use iso_c_binding
  integer, parameter :: c_uint8_t = c_int8_t
  integer, parameter :: c_uint16_t = c_int16_t
  type Foo_integer_c_uint16_t_6
    integer(kind=c_uint16_t) :: REPIDX_6(x,1)
  end type Foo_integer_c_uint16_t_6
end module test_mx_integer_c_uint16_t_6
...
! LOC
    integer, parameter :: c_uint8_t = c_int8_t
    integer, parameter :: c_uint16_t = c_int16_t
    integer(kind=c_uint16_t), pointer :: REPIDX_6(X,:)
    integer(kind=c_uint16_t), pointer :: REPIDX_6(Y,:)
    mwSize :: dims(6)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_uint16_t), pointer, intent(in) :: REPIDX_6(X,:)
