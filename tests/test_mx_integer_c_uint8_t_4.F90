...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4303319312_integer_c_uint8_t_4
!PyF95.symbol: mexFunction|template_4303319312_integer_c_uint8_t_4
!PyF95.symbol: test_mx_integer_c_uint8_t_4|template_4303319312_integer_c_uint8_t_4
!PyF95.symbol: test_explicit_interface|mexFunction|template_4303319312_integer_c_uint8_t_4
!PyF95.symbol: Foo_integer_c_uint8_t_4|test_mx_integer_c_uint8_t_4|template_4303319312_integer_c_uint8_t_4
!PyF95.symbol: special_4303087760_integer_c_uint8_t_4_4324491088|mexFunction|template_4303319312_integer_c_uint8_t_4
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_integer_c_uint8_t_4
  use iso_c_binding
  integer, parameter :: c_uint8_t = c_int8_t
  integer, parameter :: c_uint16_t = c_int16_t
  type Foo_integer_c_uint8_t_4
    integer(kind=c_uint8_t) :: REPIDX_4(x,1)
  end type Foo_integer_c_uint8_t_4
end module test_mx_integer_c_uint8_t_4
...
! LOC
    integer, parameter :: c_uint8_t = c_int8_t
    integer, parameter :: c_uint16_t = c_int16_t
    integer(kind=c_uint8_t), pointer :: REPIDX_4(X,:)
    integer(kind=c_uint8_t), pointer :: REPIDX_4(Y,:)
    mwSize :: dims(4)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_uint8_t), pointer, intent(in) :: REPIDX_4(X,:)
