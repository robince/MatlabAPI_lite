...
!................................................................................
!PyF95.hash: 0
!PyF95.symbol: template_4316070544_integer_c_int16_t_6
!PyF95.symbol: mexFunction|template_4316070544_integer_c_int16_t_6
!PyF95.symbol: test_mx_integer_c_int16_t_6|template_4316070544_integer_c_int16_t_6
!PyF95.symbol: test_explicit_interface|mexFunction|template_4316070544_integer_c_int16_t_6
!PyF95.symbol: Foo_integer_c_int16_t_6|test_mx_integer_c_int16_t_6|template_4316070544_integer_c_int16_t_6
!PyF95.symbol: special_4303250512_integer_c_int16_t_6_4322613904|mexFunction|template_4316070544_integer_c_int16_t_6
!PyF95.end
#include "fintrf.h"
#include "repidx.h"
...
! outside the module)
module test_mx_integer_c_int16_t_6
  use iso_c_binding
  type Foo_integer_c_int16_t_6
    integer(kind=c_int16_t) :: REPIDX(x,1,6)
  end type Foo_integer_c_int16_t_6
end module test_mx_integer_c_int16_t_6
...
! ARG
    ...
    integer(4) nlhs, nrhs
! LOC
    integer(kind=c_int16_t), pointer :: REPIDX(X,:,6)
    integer(kind=c_int16_t), pointer :: REPIDX(Y,:,6)
    mwSize :: dims(6)
    ...
    subroutine test_explicit_interface(X, subloc)
      integer(kind=c_int16_t), pointer, intent(in) :: REPIDX(X,:,6)
      mwPointer, intent(out) :: subloc

      subloc = loc( REPIDX(X,1,6) )
